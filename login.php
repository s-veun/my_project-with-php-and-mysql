...
if (isset($_POST['submit'])) {  // Changed from 'login' to 'submit' to match the button name
    $email = trim($_POST['email']);
    $password = $_POST['password'];

    // Prepare statement to prevent SQL Injection
    $stmt = $con->prepare("SELECT id, name, password, role FROM users WHERE email = ? LIMIT 1");
              ...
              <div class="card-body">
                ...
                <form role="form" action="login.php" method="POST" class="text-start">
                  ...
                  <div class="text-center">
                    <button type="submit" name="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign in</button>
                  </div>
